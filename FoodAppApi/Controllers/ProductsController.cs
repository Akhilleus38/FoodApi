...
namespace FoodApi.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(FoodAppDbContext dbContext)
        {
        ...
        [Authorize(Roles = "Admin")]
        [HttpPost]
        public IActionResult Post([FromBody] ProductApiModel model)
        {
        ...
        [Authorize(Roles = "Admin")]
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] ProductApiModel product)
        {
            var entity = _dbContext.Products.FirstOrDefault(x => x.Id == id);
            if (entity == null)
            {
